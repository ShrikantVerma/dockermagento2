...
#mysql -u root -p$MYSQL_ROOT_PASSWORD -e "CREATE USER 'magento-master'@'localhost' IDENTIFIED BY '2b48tm9c12ipd3ab';"

#mysql -u root -p$MYSQL_ROOT_PASSWORD -e "GRANT ALL PRIVILEGES ON *.* TO 'magento-master'@'localhost';"

#mysql -u root -p$MYSQL_ROOT_PASSWORD -e "CREATE USER 'magento-master'@'%' IDENTIFIED BY '2b48tm9c12ipd3ab';"

#mysql -u root -p$MYSQL_ROOT_PASSWORD -e "GRANT ALL PRIVILEGES ON *.* TO 'magento-master'@'%';"
